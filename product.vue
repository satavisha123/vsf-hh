    ...
    <div class="product">
      ...
      <div class="product__info">
        ...
        <div class="icons ship-to-home" id="shipToHomeContainer">
          ...
          <div class="information-container">
            <h4 class="icon-title"  style="padding-left: 70px; font-weight: 900; font-size: 26px">Ship to Home</h4>
            <p class="icon-text">
              <span class="available" style="padding-left: 70px;"> Available </span>

              for shipping to <strong>N0B2N0</strong>
            </p>

            <p class="get-it-by" style="padding-left: 70px;">Estimated Arrival: 8-10 business days</p>
